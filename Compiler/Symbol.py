class Symbol(object):
    ...
    Symbol objects, in aggregate, contain the needed information for building the memory structure of each NucaScript program
    during compilation time. They are instantiated, stored and manipulated by SymbolTable instances.
