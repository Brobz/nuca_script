...
const map<int, string> CONSTANTS = {
										...
										{6011, ": "},
										{6012, "file.txt"},
										{6013, " // An extra funny comment to confirm this works : ) //"},
										};
// CONSTANTS //
...
const vector<vector<int>> QUADS = {
										...
										{0, -1, 22001, 47011},
										{1, 47010, 47011, 47012},
										{30, 32000, 6012, 47012, 122001, 1500},
										{34, -1, -1, -1},
										};
// QUADS //
