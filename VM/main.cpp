...
const map<int, vector<vector<int>>> FUNCTION_MEMORY_CONTEXT_SIGN = {
										{1, {{1,0,4,0,1}, {19,1,11,0,1}, {9,0,6,2,0}}},
										};
// FUNCTION_MEMORY //
...
const vector<vector<int>> QUADS = {
										...
										{18, -1, 2, 160000},
										{29, -1, 20003, 220000},
										{1, 220000, 20004, 250001},
										{29, -1, 250001, 190007},
										{1, 190007, 20004, 250002},
										{30, 250002, 2, 3, 250003},
										{20, 160000, 250003, 700000, -1, -1},
										{16, -1, 0, 190008},
										{15, -1, 1, 3},
										{0, -1, 1, 190008},
										{16, -1, 0, 190009},
										{14, 700001, 190008, 190009},
										{19, 160000, 190009, 250004, 1},
										{19, 160000, 700000, 250005, -1, -1},
										{3, 250005, 4, 250006},
										{1, 250004, 250006, 250007},
										{20, 160000, 250007, 190009, 2, -1},
										{19, 160000, 700000, 250008, -1, -1},
										{30, 250008, 2, 3, 250009},
										{31, -1, 250009, 190010},
										{26, -1, -1, 190010},
										{16, -1, 0, 190011},
										{15, -1, 1, 3},
										{0, -1, 1, 190011},
										{16, -1, 0, 190012},
										{14, 700001, 190011, 190012},
										{16, -1, 0, 250010},
										{19, 160000, 190012, 250010, 1},
										{31, -1, 250010, 190013},
										{26, -1, -1, 190013},
										{28, -1, -1, -1},
										{2, -1, 5, 190014},
