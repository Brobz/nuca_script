...
const map<int, vector<vector<int>>> FUNCTION_MEMORY_CONTEXT_SIGN = {
										{424, {{6,0,0,0,7}, {27,1,11,1,2}, {10,1,30,2,0}}},
...
const map<int, string> CONSTANTS = {
										...
										{160006, "3"},
										{20015, "HI"},
										{20016, "HELLO, THIS WILL PROBABLY GO WRONG 5.54 TABULATOr"},
										{20017, "---!---"},
										{20018, "!!!!"},
										{310000, "3"},
										{310001, "2"},
										...
										{20022, ">> Before Sort:"},
										{20023, ">> After sort:"},
										{20024, "Examples/matrix_input.txt"},
										{20025, ","},
										{20026, ">> Before multiplication:"},
										{20027, ">> After multiplication:"},
										{20028, ">> Enter a funny string:\n-- "},
										{20029, ">> All done : )"},
										};
// CONSTANTS //
...
const vector<vector<int>> QUADS = {
										...
										{1, 3, 190008, 190009},
										{0, -1, 190009, 40005},
										{20, 160000, 20017, 701000, -1, -1},
										{16, -1, 0, 190010},
										{15, -1, 3, 5},
										{0, -1, 3, 190010},
										{16, -1, 0, 190011},
										{14, 160001, 190010, 190011},
										{20, 190011, 20018, 701000, -1, 1},
										{18, -1, 3, 160006},
										{16, -1, 0, 190012},
										{15, -1, 5, 5},
										{0, -1, 5, 190012},
										...
										{7, 40005, 0, 280000},
										{36, -1, 280000, 513},
										{1, 20019, 40005, 250005},
										{1, 250005, 20020, 250006},
										{16, -1, 0, 190018},
										{15, -1, 40005, 5},
										{0, -1, 40005, 190018},
										{16, -1, 0, 190019},
										...
										{24, 1, 190019, 13},
										{0, -1, 40001, 190020},
										{1, 250006, 190020, 250007},
										{1, 250007, 20021, 250008},
										{16, -1, 0, 190021},
										{15, -1, 40005, 5},
										{0, -1, 40005, 190021},
										{16, -1, 0, 190022},
										{14, 160001, 190021, 190022},
										{19, 190022, 701000, 250009, -1, 1},
