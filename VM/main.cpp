...
const map<int, vector<vector<int>>> FUNCTION_MEMORY_CONTEXT_SIGN = {
										{424, {{6,0,0,0,7}, {28,1,11,1,2}, {10,1,29,2,0}}},
...
const map<int, string> CONSTANTS = {
										...
										{20002, "] = "},
										{6, "24"},
										{20003, "--- FLOAT MATRIX A ---"},
										{20004, "float_matrix_a["},
										{20005, "]["},
										{20006, "--- FLOAT MATRIX B ---"},
										{20007, "float_matrix_b["},
										{20008, "--- FLOAT MATRIX C ---"},
										{20009, "float_matrix_c["},
										{7, "50"},
										...
										{20021, ">> Before Sort:"},
										{20022, ">> After sort:"},
										{20023, "Examples/matrix_input.txt"},
										{20024, ","},
										{20025, ">> Before multiplication:"},
										{20026, ">> After multiplication:"},
										{20027, ">> Enter a funny string:\n-- "},
										{20028, ">> All done : )"},
										};
// CONSTANTS //
...
const vector<vector<int>> QUADS = {
										...
										{7, 340000, 1, 580000},
										{36, -1, 580000, 77},
										{1, 20001, 340000, 550000},
										{1, 550000, 20002, 550001},
										{16, -1, 0, 490002},
										{15, -1, 340000, 25},
										{0, -1, 340000, 490002},
										{16, -1, 0, 490003},
										...
										{7, 340001, 0, 580001},
										{36, -1, 580001, 226},
										{1, 20004, 340000, 550000},
										{1, 550000, 20005, 550001},
										{1, 550001, 340001, 550002},
										{1, 550002, 20002, 550003},
										{16, -1, 0, 490004},
										{15, -1, 340000, 5},
										{16, -1, 0, 490005},
										{0, -1, 340000, 490005},
										...
										{7, 340001, 0, 580003},
										{36, -1, 580003, 261},
										{1, 20007, 340000, 550005},
										{1, 550005, 20005, 550006},
										{1, 550006, 340001, 550007},
										{1, 550007, 20002, 550008},
										{16, -1, 0, 490011},
										{15, -1, 340000, 5},
										{16, -1, 0, 490012},
										{0, -1, 340000, 490012},
										...
										{7, 340001, 0, 580005},
										{36, -1, 580005, 296},
										{1, 20009, 340000, 550010},
										{1, 550010, 20005, 550011},
										{1, 550011, 340001, 550012},
										{1, 550012, 20002, 550013},
										{16, -1, 0, 490018},
										{15, -1, 340000, 5},
										{16, -1, 0, 490019},
										{0, -1, 340000, 490019},
										...
										{17, 5, 2, 160001},
										{3, 20000, 0, 250000},
										{1, 20015, 250000, 250001},
										{3, 10000, 4, 220000},
										{1, 250001, 220000, 250002},
										{26, -1, -1, 250002},
										{28, -1, -1, -1},
										{3, 3, 30000, 190000},
										{26, -1, -1, 190000},
										...
										{0, -1, 5, 190007},
										{16, -1, 0, 190008},
										{14, 160001, 190007, 190008},
										{21, -1, -1, 185},
										{24, 1, 190008, 185},
										{0, -1, 40004, 190009},
										{1, 3, 190009, 190010},
										{0, -1, 190010, 40005},
										{20, 160000, 20016, 701000, -1, -1},
										{16, -1, 0, 190011},
										{15, -1, 3, 5},
										{0, -1, 3, 190011},
										{16, -1, 0, 190012},
										{14, 160001, 190011, 190012},
										{20, 190012, 20017, 701000, -1, 1},
										{18, -1, 3, 160006},
										{16, -1, 0, 190013},
										{15, -1, 5, 5},
										{0, -1, 5, 190013},
										{16, -1, 0, 190014},
										{14, 160001, 190013, 190014},
										{18, 1, 2, 190014},
										{16, -1, 0, 190015},
										{15, -1, 3, 5},
										{0, -1, 3, 190015},
										{16, -1, 0, 190016},
										{14, 160001, 190015, 190016},
										{19, 190016, 701000, 250003, -1, 1},
										{26, -1, -1, 250003},
										{19, 160000, 701000, 250004, -1, -1},
										{26, -1, -1, 250004},
										{28, -1, -1, -1},
										{0, -1, 5, 40005},
										{7, 40005, 0, 280000},
										{36, -1, 280000, 514},
										{1, 20018, 40005, 250005},
										{1, 250005, 20019, 250006},
										{16, -1, 0, 190019},
										{15, -1, 40005, 5},
										{0, -1, 40005, 190019},
										{16, -1, 0, 190020},
										{14, 160001, 190019, 190020},
										{21, -1, -1, 13},
										{22, -1, 9, 340000},
										{24, 1, 190020, 13},
										{0, -1, 40001, 190021},
										{1, 250006, 190021, 250007},
										{1, 250007, 20020, 250008},
										{16, -1, 0, 190022},
										{15, -1, 40005, 5},
										{0, -1, 40005, 190022},
										{16, -1, 0, 190023},
										{14, 160001, 190022, 190023},
										{19, 190023, 701000, 250009, -1, 1},
										{1, 250008, 250009, 250010},
										{26, -1, -1, 250010},
										{28, -1, -1, -1},
										{16, -1, 1, 190017},
										{1, 40005, 190017, 190018},
										{0, -1, 190018, 40005},
										{35, -1, -1, 486},
										{21, -1, -1, 13},
										{22, -1, 9, 340000},
