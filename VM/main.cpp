...
const map<int, vector<vector<int>>> FUNCTION_MEMORY_CONTEXT_SIGN = {
										{1, {{3,0,0,0,1}, {28,3,12,4,1}, {7,0,4,0,0}}},
										};
// FUNCTION_MEMORY //
...
const vector<vector<int>> QUADS = {
										...
										{0, -1, 12000, 37001},
										{16, -1, 0, 37002},
										{14, 112000, 37001, 37002},
										{1, 12000, 6000, 47000},
										{28, -1, 47000, 37003},
										{19, 32000, 37003, 37002, 2},
										{16, -1, 0, 37004},
										{15, -1, 12000, 30},
										{0, -1, 12000, 37004},
										{16, -1, 0, 37005},
										{14, 122000, 37004, 37005},
										{1, 12000, 6000, 47001},
										{19, 32000, 47001, 37005, 2},
										{16, -1, 0, 37006},
										{15, -1, 12000, 10},
										{0, -1, 12000, 37006},
										{16, -1, 0, 37007},
										{14, 117000, 37006, 37007},
										{3, 12000, 3, 42000},
										{1, 42000, 6000, 47002},
										{28, -1, 47002, 42001},
										{19, 32000, 42001, 37007, 2},
										{3, 12000, 4, 37008},
										{16, -1, 0, 37009},
										{15, -1, 37008, 30},
										{0, -1, 37008, 37009},
										{16, -1, 0, 37010},
										{14, 122000, 37009, 37010},
										{16, -1, 0, 37011},
										{15, -1, 12000, 10},
										{0, -1, 12000, 37011},
										{16, -1, 0, 37012},
										{14, 117000, 37011, 37012},
										{16, -1, 0, 42002},
										{18, 32000, 37012, 42002, 1},
										{1, 42002, 6000, 47003},
										{19, 32000, 47003, 37010, 2},
										{16, -1, 0, 37013},
										{15, -1, 12000, 10},
										{0, -1, 12000, 37013},
										{16, -1, 0, 37014},
										{14, 127000, 37013, 37014},
										{6, 12000, 5, 52001},
										{1, 52001, 6000, 47004},
										{28, -1, 47004, 52002},
										{19, 32000, 52002, 37014, 2},
										{3, 12000, 6, 37015},
										{16, -1, 0, 37016},
										{15, -1, 37015, 30},
										{0, -1, 37015, 37016},
										{16, -1, 0, 37017},
										{14, 122000, 37016, 37017},
										{16, -1, 0, 37018},
										{15, -1, 12000, 10},
										{0, -1, 12000, 37018},
										{16, -1, 0, 37019},
										{14, 127000, 37018, 37019},
										{16, -1, 0, 52003},
										{18, 32000, 37019, 52003, 1},
										{1, 52003, 6000, 47005},
										{19, 32000, 47005, 37017, 2},
										{16, -1, 0, 37020},
										{15, -1, 12000, 30},
										{0, -1, 12000, 37020},
										{16, -1, 0, 37021},
										{14, 122000, 37020, 37021},
										{16, -1, 0, 47006},
										{18, 32000, 37021, 47006, 1},
										{1, 6001, 47006, 47007},
										{25, -1, -1, 47007},
										{27, -1, -1, -1},
										{3, 12000, 4, 37022},
										...
										{0, -1, 37022, 37023},
										{16, -1, 0, 37024},
										{14, 122000, 37023, 37024},
										{16, -1, 0, 47008},
										{18, 32000, 37024, 47008, 1},
										{1, 6002, 47008, 47009},
										{25, -1, -1, 47009},
										{27, -1, -1, -1},
										{3, 12000, 6, 37025},
										...
										{0, -1, 37025, 37026},
										{16, -1, 0, 37027},
										{14, 122000, 37026, 37027},
										{16, -1, 0, 47010},
										{18, 32000, 37027, 47010, 1},
										{1, 6003, 47010, 47011},
										{25, -1, -1, 47011},
										{27, -1, -1, -1},
										{1, 12000, 3, 37000},
    ...
    switch(op) {
      ...
      case 26:			// PRNT
			...
			case 28:			// STOX
        {
					...
					string stoi_arg = read_from_memory(QUADS[IP][2]).s;
					...
					if (this_mem->id != -1) write_to_memory(this_mem, result_dir, stoi_arg);
					else write_to_memory(result_dir, stoi_arg);
