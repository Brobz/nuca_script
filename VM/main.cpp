...
const map<int, vector<vector<int>>> FUNCTION_MEMORY_CONTEXT_SIGN = {
										{1, {{1,0,2,0,0}, {2,0,0,8,0}, {1,0,15,2,0}}},
										};
// FUNCTION_MEMORY //
...
const map<int, string> CONSTANTS = {
										{30000, "0"},
										{30001, "1"},
										{20000, "Hola, buenos dias. Como te llamas?"},
										{20001, "Mucho gusto"},
										{20002, "Oye tengo una pregunta, cual es tu color favorito?"},
										{20003, "rosa"},
										{20004, "Rosa"},
										{20005, ">> Que padre el mio tambien"},
										{20006, "blanco"},
										{20007, "Blanco"},
										{20008, ">> Ese no esta padre"},
										{20009, ">> Esta bien pero mi favorito es rosa"},
										{20010, "Ahora dime cuantos anios tienes"},
										{0, "23"},
										{20011, ">> Ah eres"},
										{20012, "menor que yo"},
										{20013, ">> Ah yo tambien"},
...
const vector<vector<int>> QUADS = {
										...
										{28, -1, -1, -1},
										{25, -1, -1, 100001},
										{5, 100001, 20003, 280000},
										{5, 100001, 20004, 280001},
										{11, 280000, 280001, 280002},
										{36, -1, 280002, 17},
										{26, -1, -1, 20005},
										{28, -1, -1, -1},
										{35, -1, -1, 26},
										{5, 100001, 20006, 280003},
										{5, 100001, 20007, 280004},
